...
namespace WeAreMadeToHeal
{
    ...
    [ApiVersion("1.0")]
    public class BaseCustomerController<T, TLogic> : ControllerBase where T : BaseEntity where TLogic : IBaseLogicProvider<T>
    {
        #region [ Fields ]
        private readonly ILogger<BaseCustomerController<T, TLogic>> _logger;
